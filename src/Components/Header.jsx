...
import { logos, gitHubUrl } from "../Details";
    ...
    <header className="relative md:sticky md:top-0 container bg-white dark:bg-gray-900 z-20 mx-auto md:flex justify-between py-2 max-width transition-colors duration-200">
      <div className="flex justify-between items-center py-2 md:py-3">
        ...
        <div onClick={toggleClass} className="cursor-pointer">
          <svg
            className="stroke-dark-heading dark:stroke-white md:hidden transition-colors duration-200"
            width="25"
            height="20"
            viewBox="0 0 16 13"
            fill="none"
      ...
      >
        <ul className="dark:text-light-content font-medium flex flex-col md:flex-row md:space-x-5 items-center">
          <li className="pb-1 md:pb-0 hover:text-[#9260F5]">
        ...
        <ul className="flex justify-evenly items-center md:my-0 md:space-x-5 md:mr-5 md:ml-5 mb-4 mt-4 md:mt-0">
          <li>
