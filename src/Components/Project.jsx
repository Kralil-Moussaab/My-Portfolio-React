...
function Project({
  ...
  return (
    <article className="rounded-xl mt-10 border-2 border-dark-card overflow-hidden h-min ">
      <img src={image} alt="" loading="lazy" />
      <div className="dark:bg-dark-card p-4 border-t-2 border-dark-card transition-colors duration-200">
        <h1 className="dark:text-light-heading font-semibold text-lg pt-1">
          {title}
        </h1>
        <p className="dark:text-light-content text-lg text-black pt-4 font-light">
          {description}
        </p>
        <h3 className="text-black text-lg dark:text-light-heading font-medium pt-4">
          Technologie : <span className="font-light">{technologie}</span>
        </h3>
        <div className="flex justify-between items-center mt-5">
          <div className="flex items-center">
            <svg
              className="stroke-dark-heading dark:stroke-white inline-block min-w-fit transition-colors duration-200"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
          ...
          <div className="flex items-center">
            <svg
              className="dark:fill-light-heading fill-dark-heading inline-block min-w-fit transition-colors duration-200"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
